...
Active companion controls: State_Vocabulary_Register v1.17 (per-file states, conventions, Machine Guards); Project_Procedures v3.2 (workflow); Restart Capsule v11.15 (chronology, anchors, operators); Repository_Change_Archive v1.4 (non-controlling history; last-attested edition — location and maintenance under author review June 11 2026)
